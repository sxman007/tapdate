...
<div class="search-well">
    <?php
    echo $this->Form->create('User',array('type' => 'post','url' => array('controller' => 'users','action' => 'owners','admin' => TRUE)));
...
<div class="btn-toolbar">
    <a href="<?php echo $this->Html->url(array('action' => 'add', 'admin' => TRUE, 'owner')); ?>" class="btn btn-primary"><i class="icon-plus"></i> Add</a>
</div>
<!-- New user button start -->
            ...
            if ($count) {
                foreach ($results as $loop => $result) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo $this->Html->url(array('action' => 'edit', 'admin' => TRUE, $result['User']['id'], 'owner')); ?>" title="Edit"><i class="icon-pencil"></i></a>
