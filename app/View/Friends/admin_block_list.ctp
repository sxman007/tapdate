<div class="header">
    <h1 class="page-title">Blocks List</h1>
</div>
...
<div class="search-well">
    ...
    echo $this->Form->create('User',array('type' => 'post','url' => array('controller' => 'friends','action' => 'block_list','admin' => TRUE)));
                ...
                foreach ($results as $loop => $result) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo $this->Html->url(array('action' => 'block_delete', 'admin' => TRUE,$user_id, $result['User']['id'])); ?>" onclick="if (!confirm('Are you sure want to delete this record permanently?')) return false;" title="Delete"><i class="icon-remove"></i></a>
                        </td>
                    </tr>
                    <?php
                }
