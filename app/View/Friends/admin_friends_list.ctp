...
<div class="search-well">
    ...
    echo $this->Form->create('User',array('type' => 'post','url' => array('controller' => 'friends','action' => 'friends_list','admin' => TRUE)));
                ...
                foreach ($results as $loop => $result) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo $this->Html->url(array('action' => 'friends_delete', 'admin' => TRUE,$user_id, $result['User']['id'])); ?>" onclick="if (!confirm('Are you sure want to delete this record permanently?')) return false;" title="Delete"><i class="icon-remove"></i></a>
                        </td>
                    </tr>
                    <?php
                }
