...
class AppController extends Controller {
    ...
    public function errorMessage($type) {
        ...
        switch ($type) {
            ...
            case 'eep_code_generation_success':
                ...
                break;
             case 'user_friend_not_same':

                $msg = __('User and friend should not be same.');
		...
		case 'already_like':
                ...
                $msg = __('Already like this friend');
    ...
    public function base64_to_jpeg($base64_string) {
        define('UPLOAD_DIR', WWW_ROOT . 'uploads/users/images/');
        $image_decode = base64_decode($base64_string, true);
        $filename = uniqid() . '.jpg';
        $file_dir = UPLOAD_DIR . $filename;
        $success = file_put_contents($file_dir, $image_decode);
        return $filename;
    }
