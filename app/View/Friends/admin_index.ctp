<div class="header">
    <h1 class="page-title">Friends Request List</h1>
</div>
...
<div class="search-well">
    ...
    echo $this->Form->create('User',array('type' => 'post','url' => array('controller' => 'friends','action' => 'index','admin' => TRUE)));
                ...
                foreach ($results as $loop => $result) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <a href="<?php echo $this->Html->url(array('action' => 'activate', 'admin' => TRUE,$user_id, $result['User']['id'], 3)); ?>" title="block"><i class="icon-ban-circle"></i></a>
                            <a href="<?php echo $this->Html->url(array('action' => 'activate', 'admin' => TRUE,$user_id, $result['User']['id'], 1)); ?>" title="accept"><i class="icon-ok-circle"></i></a>

                            <a href="<?php echo $this->Html->url(array('action' => 'delete', 'admin' => TRUE,$user_id, $result['User']['id'])); ?>" onclick="if (!confirm('Are you sure want to delete this record permanently?')) return false;" title="Delete"><i class="icon-remove"></i></a>
                        </td>
                    </tr>
                    <?php
                }
